...
const { ensureBonusSchema, ensureQuestionTrackingSchema } = require('../db-schema');
  ...
  if (event.httpMethod === 'POST') {
    ...
    if (action === 'start') {
      ...
      await sql`
        ...
        VALUES (1, NOW(), NULL, NULL, 10, NULL, NULL)
    ...
    if (action === 'stop') {
      ...
      await sql`
        ...
        VALUES (1, NULL, NOW(), NOW() + INTERVAL '5 minutes', 10, NULL, NULL)
        ON CONFLICT (id) DO UPDATE
        SET
          started_at = NULL,
          ended_at = NOW(),
    ...
    if (action === 'set-announcement') {
      ...
      await sql`
        ...
        VALUES (1, NULL, NULL, NULL, 10, NULL, NULL)

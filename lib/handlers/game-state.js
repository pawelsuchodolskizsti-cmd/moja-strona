  ...
  if (event.httpMethod === 'POST') {
    ...
    if (action === 'start') {
      ...
      await sql`
        ...
        VALUES (${stateId}, ${scope}, NOW(), NULL, NULL, 10, NULL, NULL, NULL, NULL)
    ...
    if (action === 'stop') {
      ...
      await sql`
        ...
        VALUES (${stateId}, ${scope}, NULL, NOW(), NOW() + INTERVAL '5 minutes', 10, NULL, NULL, NULL, NULL)
        ON CONFLICT (scope) DO UPDATE
        SET
          id = EXCLUDED.id,
          started_at = NULL,
    ...
    if (action === 'set-announcement') {
      ...
      await sql`
        ...
        VALUES (${stateId}, ${scope}, NULL, NULL, NULL, 10, NULL, NULL, NULL, NULL)

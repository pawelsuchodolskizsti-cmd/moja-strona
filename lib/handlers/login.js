...
exports.handler = async (event) => {
  ...
  const { firstName, lastName, city, email, deviceToken } = JSON.parse(event.body || '{}');
  ...
  try {
    ...
    const rows = await sql`
      INSERT INTO participants (first_name, last_name, city, email, device_token, last_ip, last_user_agent, last_activity)
      VALUES (
        ${normalizedFirstName},
        ${normalizedLastName},
        ${normalizedCity},

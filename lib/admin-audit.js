...
function details(body){
 const out={};for(const k of ['contactId','participantId','questionId','institutionId','bonusId','ticketId','targetId','targetType','minutes','active','revision','enabled','status','scope'])if(body[k]!==undefined)out[k]=body[k];
